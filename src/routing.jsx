            ...
            <Fragment>
                <Routes>
                    <Route path='/' exact
                        ...
                        element={filterUsername.length > 0 ? <Navigate  to='/homePage' /> : <LoginPage getNamePass={getNamePass} sendRegData={sendRegData} changeLogin={changeLogin} isLogin={isLogin} getAuthCredentials={getAuthCredentials} authCredentials={authCredentials} />}

                    />

                    <Route path='/homePage'

                        element={<HomePage filterUsername={filterUsername} handleLogOut={handleLogOut} />}
